<template>
  <div>
    ...
    <div class="text-center mt-3 mb-3"><h2>台中腔-美食特搜版</h2></div>
...
<script>
import ProductModal from "../../components/topModalB.vue";
...
export default {
  ...
  methods: {
    getTopList() {
      this.isLoading = true;
      this.$http("https://apilan.news-age.tw/getData/position/台中腔/lifeC")
        .then((res) => {           
             setTimeout(() => {
